     ...
     <LibraryContext.Provider value={contextValue}>
      <div className="library-container">
        ...
        <nav>
          ...
          <a href="http://localhost:8000/storage/kepek/kobalt.jpg" className="konyv-link" title="Kobalt - Részletek">
          <img src="http://bookline.hu" alt="Kobalt" />
          </a>
          <a href="http://localhost:8000/storage/kepek/satantango.jpg" className="konyv-link" title="Sátántangó - Részletek">
          <img src="http://bookline.hu" alt="satantango" />
          </a>
          <a href="http://localhost:8000/storage/kepek/azegmindenkekje.jpg" className="konyv-link" title="Az ég minden kékje - Részletek">
          <img src="http://bookline.hu" alt="azegmindenkekje" />
          </a>
          </div>
          <hr />
          <SearchBar />
...
const BookList = () => {
  ...
  const handleFoglalas = (bookId: number, bookTitle: string) => {
    fetch(`https://localhost:8000/api/foglalas`, {
        method: 'POST',
